        ...
        <div class="row py-4">
            ...
            <div class="col-4">
                <p class="text-center mb-0">
                    <a href="#" class="text-decoration-none text">Conditions d'utilisation</a>
                    <span class="purple"> | </span>
                    <a href="#" class="text-decoration-none text">Politique de confidentialité</a>
                </p>
            </div>
            <div class="col-4 d-flex justify-content-end pe-5">
                <!-- Facebook -->
                <a href="https://www.facebook.com/" target="_blank" class="mb-0 px-2 text">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                        <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                    </svg>
                </a>
                <!-- Instagram -->
                <a href="https://www.instagram.com/" target="_blank" class="mb-0 px-2 mx-3 text">
                ...
                <!-- Twitter -->
                <a href="https://twitter.com/" target="_blank" class="mb-0 px-2 me-3 text">
                ...
                <!-- Discord -->
                <a href="https://discord.com/" target="_blank" class="mb-0 px-2 text">
